...
namespace qffixlib
{
	namespace v50sp2
	{
		namespace Message
		{
            ...
            using NewOrderSingle = FIXMessage<FIX::MsgType::NewOrderSingle, Types::ClOrdID, Group<FIX::Tag::NoPartyIDs, Types::PartyRole>, Types::ExecInst, Types::OrderQty, Types::OrdType, Types::Price,
